  ...
  ? (
      [
        ...
        },
        {
          ...
          features: ["ibc-transfer", "ibc-go"],
          explorerUrlToTx:
            "https://explorer.sandbox-01.aksh.pw/akash/tx/{txHash}",
        },
        {
  ...
  : (
      [
        ...
        },
        {
          ...
          features: ["ibc-transfer"],
          explorerUrlToTx:
            "https://emoney.bigdipper.live/transactions/{txHash}",
        },
        {
        ...
        },
        {
          ...
          features: ["ibc-transfer"],
          explorerUrlToTx:
            "https://explorer.microtick.zone/transactions/{txHash}",
        },
        {
          ...
          features: ["ibc-transfer", "ibc-go"],
          explorerUrlToTx:
            "https://likecoin.bigdipper.live/transactions/{txHash}",
        },
        {
        ...
        },
        {
          ...
          features: ["ibc-transfer", "ibc-go"],
          explorerUrlToTx:
            "https://www.mintscan.io/gravity-bridge/txs/{txHash}",
        },
        {
        ...
        },
        {
          ...
          features: ["ibc-transfer", "ibc-go"],
          explorerUrlToTx:
            "https://explorer.postcapitalist.io/galaxy/tx/{txHash}",
        },
        {
        ...
        },
        {
          ...
          features: ["ibc-transfer", "ibc-go"],
          explorerUrlToTx:
            "https://explorer.chaintools.tech/lumenx/tx/{txHash}",
        },
        {
        ...
        },
        {
          ...
          features: ["ibc-transfer", "ibc-go"],
          explorerUrlToTx:
            "https://agoric.bigdipper.live/transactions/{txHash}",
        },
        {
        ...
        },
        {
          ...
          features: ["ibc-transfer", "ibc-go"],
          explorerUrlToTx:
            "https://explorer.thesilverfox.pro/beezee/tx/{txHash}",
        },
        {
        ...
        },
        {
          ...
          features: ["ibc-transfer", "ibc-go"],
          explorerUrlToTx:
            "https://www.mintscan.io/onomy-protocol/txs/{txHash}",
        },
        {
